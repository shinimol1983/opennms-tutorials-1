...
In [Exercise-4-1](../session3/Exercise-4-1.md) we will look at the OpenNMS Database and the Event Translator.

In [Exercise-4-2](../session3/Exercise-4-2.md) we will create a real event translator example for our smart motorway.

In [Exercise-4-3](../session3/Exercise-4-3.md) we will look at how Drools Rules can be used to modify the alarm behaviour
